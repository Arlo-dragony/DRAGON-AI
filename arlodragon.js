...
if (badwordkick === 'TRUE' && isBotAdmin && !isAdmin && body && (new RegExp('\\b' + badword.join('\\b|\\b') + '\\b')).test(body.toLowerCase())) {
 ...
 client.sendMessage(m.chat, {text:`𝐇𝐞𝐲 @${kid.split("@")[0]}👋\n\n𝗦𝗲𝗻𝗱𝗶𝗻𝗴  𝗟𝗶𝗻𝗸𝘀 𝗶𝘀 𝗣𝗿𝗼𝗵𝗶𝗯𝗶𝘁𝗲𝗱 🎭 !`, contextInfo:{mentionedJid:[kid]}}, {quoted:m}); 
       }   
...
client.sendMessage(m.chat, { image: { url: 'https://i.imgur.com/jKO8anU.jpeg' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
...
//========================================================================================================================//	      
 ...
 const yts = require("yt-search");
    ...
    try {
        ...
        try {
            let data = await fetchJson(`https://api.giftedtech.web.id/api/download/ytmp3?apikey=${urlYt}`);
...
const fetch = require("node-fetch"); 
  ...
  try {
    ...
    const apiUrl = `https://api.giftedtech.web.id/api/download/ytmp3?apikey=${link}`;
...
const fetch = require("node-fetch"); 
  ...
  try { 
    ...
    const apiUrl = `https://api.giftedtech.web.id/api/download/ytdl?apikey=${link}`;
...
//========================================================================================================================//		      
        ...
        async function redeployApp() {
            try {
                ...
                await m.reply("Your bot is undergoing a ruthless upgrade, hold tight for the next 2 minutes as the redeploy executes! Once done, you’ll have the freshest version of *𝙳𝚁𝙰𝙶𝙾𝙽 𝙰𝙸👾* unleashed upon you.");
...
//========================================================================================================================//
	      case "Arlodragon":
		{
        if (!text) return reply(`Hello I'm 𝙳𝚁𝙰𝙶𝙾𝙽 𝙰𝙸👾. How can i help u?`);
          let d = await fetchJson(
            `https://bk9.fun/ai/llama?q=${text}`
          );
          if (!d.BK9) {
            return reply(
              "An error occurred while fetching the 𝙳𝚁𝙰𝙶𝙾𝙽 𝙰𝙸👾chatbot response. Please try again later."
            );
          } else {
            reply(d.BK9);
          }
...
//========================================================================================================================//		      
  ...
  try {
    ...
    if (!text) {
      return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝙳𝚁𝙰𝙶𝙾𝙽 𝙰𝙸👾, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    }
    if (!/image/.test(mime)) {
...
//========================================================================================================================//		      
    ...
    try {
      ...
      await client.groupUpdateDescription(groupId, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 𝙳𝚁𝙰𝙶𝙾𝙽 𝙰𝙸👾 !");
...
await client.sendMessage(m.chat, { image: { url: imageurl}, caption: `𝙳𝚁𝙰𝙶𝙾𝙽 𝙰𝙸👾`}, { quoted: m}) 
...
//========================================================================================================================//		      
  case "system": 
              ...
              client.sendMessage(m.chat, { image: { url: 'https://i.imgur.com/jKO8anU.jpeg' }, caption:`*𝐁𝐎𝐓 𝐍𝐀𝐌𝐄: 𝙳𝚁𝙰𝙶𝙾𝙽 𝙰𝙸👾 *\n\n*𝐒𝐏𝐄𝐄𝐃: ${Rspeed.toFixed(4)} 𝐌𝐒*\n\n*𝐑𝐔𝐍𝐓𝐈𝐌𝐄: ${runtime(process.uptime())}*\n\n*𝐏𝐋𝐀𝐓𝐅𝐎𝐑𝐌: 𝗛𝗲𝗿𝗼𝗸𝘂*\n\n*𝐇𝐎𝐒𝐓𝐍𝐀𝐌𝐄: 𝙳𝚁𝙰𝙶𝙾𝙽 𝙰𝙸👾*\n\n*𝐋𝐈𝐁𝐑𝐀𝐑𝐘: Baileys*\n\n𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑: Arlodragon`}); 
 break;
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝙳𝚁𝙰𝙶𝙾𝙽 𝙰𝙸👾 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...' , mentions: participants.map(a => a.id)}, { quoted : m }); 
...
//========================================================================================================================//		      
	case 'runtime':
		let raven = `𝙳𝚁𝙰𝙶𝙾𝙽 𝙰𝙸👾 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝘀𝗶𝗻𝗰𝗲 ${runtime(process.uptime())}`
                client.sendMessage(m.chat, {
                    text: raven,
                    contextInfo: {
                        externalAdReply: {
...
try {
        ...
        pp = 'https://i.imgur.com/jKO8anU.jpeg';
      }
